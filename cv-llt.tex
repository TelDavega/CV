...
% 23 Oct, 2022
%
\documentclass[a4paper,skipsamekey,11pt,spanish]{curve}
...
\PassOptionsToPackage{style=ieee,sorting=ydnt,defernumbers=true}{biblatex}
...
\DefineBibliographyStrings{spanish}{url={\textsc{url}}}
...
\leftheader{%
  {\LARGE\bfseries\sffamily David Ortega García-Bao}

  \makefield{\faEnvelope[regular]}{\href{mailto:david.ortega4@alu.uclm.es}{\texttt{david.ortega4@alu.uclm.es}}}
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/david-ortega-garcía-bao-27004a23a/}{\texttt{David Ortega García-Bao}}}

  %% Next line
  \makefield{\faInstagram}{\href{https://www.instagram.com/david_otg27/}{\texttt{david\_otg27}}}\qquad \qquad \qquad \ \  
  \makefield{\faGithub}{\href{https://github.com/TelDavega}{TelDavega}}
